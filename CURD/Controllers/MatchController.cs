...
namespace CURD.Controllers
{
    public class MatchController : Controller
    {
        ...
        public MatchController(EmployeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MatchId,KnowledgeArea")] Match match)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MatchId,KnowledgeArea")] Match match)
        {
            if (id != match.MatchId)
            {
                return NotFound();
